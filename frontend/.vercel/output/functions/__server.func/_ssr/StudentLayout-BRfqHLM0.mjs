...
function StudentLayout({ children, activeItem }) {
  ...
  if (!user || user.role !== "STUDENT") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-8 text-center text-error font-semibold", children: "Unauthorized. Students only." });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-on-background flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex max-w-[1400px] mx-auto w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "w-64 border-r border-outline-variant/30 p-6 hidden md:block", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold mb-6 text-on-surface-variant uppercase tracking-widest text-xs", children: "Student Portal" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 p-6 lg:p-10", children })
    ] }),
