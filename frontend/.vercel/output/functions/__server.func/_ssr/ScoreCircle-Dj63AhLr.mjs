  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { width: size, height: size }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-3xl font-extrabold font-display ${getColor()}`, children: score }),
        maxScore !== 100 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-on-surface-variant font-mono", children: [
          "/ ",
          maxScore
        ] })
      ] })
    ] }),
    label && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold text-on-surface", children: label }),
    sublabel && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-on-surface-variant", children: sublabel })
  ] });
}
export {
  ScoreCircle as S
