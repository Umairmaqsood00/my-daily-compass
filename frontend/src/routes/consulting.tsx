      ...
      <div style={{ maxWidth: "880px", margin: "0 auto", padding: "0 20px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 380px), 1fr))", gap: "24px", marginTop: "28px", paddingBottom: "36px" }}>
          ...
          >
            ...
            <div style={{
              maxHeight: activeTier === 0 ? "700px" : "0px",
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "6px", marginTop: "14px", color: "#3B7DD8", fontSize: "13px", fontWeight: 600 }}>
          ...
          >
            ...
            <div style={{
              maxHeight: activeTier === 1 ? "900px" : "0px",
              overflow: "hidden", transition: "max-height 0.4s ease, opacity 0.3s ease",
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "6px", marginTop: "14px", color: "#F5A623", fontSize: "13px", fontWeight: 600 }}>
        ...
        <div style={{ textAlign: "center", paddingBottom: "48px" }}>
          <p style={{ fontSize: "12px", color: "#8A9BB5" }}>
