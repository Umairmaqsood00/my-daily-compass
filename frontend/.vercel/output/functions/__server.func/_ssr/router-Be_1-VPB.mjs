...
function AuthProvider({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthContext.Provider, { value: { user, isLoading, login, register, logout }, children });
}
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-7xl font-bold text-on-background", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 text-xl font-semibold", children: "Page not found" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-on-surface-variant", children: "The page you're looking for doesn't exist." }),
...
function ErrorComponent({ error, reset }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-on-surface-variant", children: "Something went wrong. Try refreshing." }),
...
const $$splitComponentImporter$q = () => import("./success-stories-DzacUcu1.mjs");
const Route$q = createFileRoute("/success-stories")({
  component: lazyRouteComponent($$splitComponentImporter$q, "component")
});
const $$splitComponentImporter$p = () => import("./subscriptions-C1z_HwWB.mjs");
const Route$p = createFileRoute("/subscriptions")({
  component: lazyRouteComponent($$splitComponentImporter$p, "component")
});
const $$splitComponentImporter$o = () => import("./dashboard-DYtVNuWM.mjs");
const Route$o = createFileRoute("/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$o, "component")
});
const $$splitComponentImporter$n = () => import("./contact-BShngj5D.mjs");
...
const $$splitComponentImporter$m = () => import("./index-BfsqKecS.mjs");
...
const $$splitComponentImporter$l = () => import("./index-D1WYOfIq.mjs");
const Route$l = createFileRoute("/dashboard/")({
  component: lazyRouteComponent($$splitComponentImporter$l, "component")
});
const $$splitComponentImporter$k = () => import("./index-DO7HIeDE.mjs");
const Route$k = createFileRoute("/admin/")({
  component: lazyRouteComponent($$splitComponentImporter$k, "component")
});
const $$splitComponentImporter$j = () => import("./tests-w44em5ze.mjs");
const Route$j = createFileRoute("/dashboard/tests")({
  component: lazyRouteComponent($$splitComponentImporter$j, "component")
});
const $$splitComponentImporter$i = () => import("./sat-tests-DLqvfSdN.mjs");
const Route$i = createFileRoute("/dashboard/sat-tests")({
  component: lazyRouteComponent($$splitComponentImporter$i, "component")
});
const $$splitComponentImporter$h = () => import("./practice-Dl8wdeIX.mjs");
const Route$h = createFileRoute("/dashboard/practice")({
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const $$splitComponentImporter$g = () => import("./history-ClxHiQST.mjs");
const Route$g = createFileRoute("/dashboard/history")({
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("./analytics-DFE0lptJ.mjs");
const Route$f = createFileRoute("/dashboard/analytics")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./reset-password-C0LRr15n.mjs");
const Route$e = createFileRoute("/auth/reset-password")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./register-BmfFv9_X.mjs");
const Route$d = createFileRoute("/auth/register")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./login-BcuIKxvV.mjs");
const Route$c = createFileRoute("/auth/login")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./forgot-password-Blc0M-Xr.mjs");
const Route$b = createFileRoute("/auth/forgot-password")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./users-DlS0rMPn.mjs");
const Route$a = createFileRoute("/admin/users")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./uploads-CF_0F_5o.mjs");
const Route$9 = createFileRoute("/admin/uploads")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./tests-Qq3f89ln.mjs");
const Route$8 = createFileRoute("/admin/tests")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./success-stories-sj-Ye-Kb.mjs");
const Route$7 = createFileRoute("/admin/success-stories")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./questions-CnBrV496.mjs");
const Route$6 = createFileRoute("/admin/questions")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./contact-requests-B1svPksD.mjs");
const Route$5 = createFileRoute("/admin/contact-requests")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./test-result._attemptId-ClUQqe0X.mjs");
const Route$4 = createFileRoute("/dashboard/test-result/$attemptId")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./take-test._attemptId-B-qlMXo8.mjs");
const Route$3 = createFileRoute("/dashboard/take-test/$attemptId")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./sat-runner._attemptId-dDOX4no5.mjs");
const Route$2 = createFileRoute("/dashboard/sat-runner/$attemptId")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./sat-result._attemptId-CopTfZKD.mjs");
const Route$1 = createFileRoute("/dashboard/sat-result/$attemptId")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./review-upload._uploadId-DVYptSMh.mjs");
